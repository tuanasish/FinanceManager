...
import {
    View, Text, StyleSheet, TouchableOpacity, TextInput, Dimensions, ScrollView, Animated
} from 'react-native';
import { SafeAreaView, useSafeAreaInsets } from 'react-native-safe-area-context';
import { Icon } from '../components/ui/Icon';
import { COLORS, RADIUS, SHADOWS, FONTS, SPACING } from '../constants/theme';
import { addTransaction, getCategoriesByType, CategoryRow } from '../db';
...
const styles = StyleSheet.create({
    ...
    numKey: {
        width: (width - 48 - 32) / 3, // container width - padding - gap
        height: 60,
        backgroundColor: COLORS.background,
        borderRadius: RADIUS.btn,
        alignItems: 'center',
